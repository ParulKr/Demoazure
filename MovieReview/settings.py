...
SECRET_KEY = 'django-insecure-4(l#=bg=3=k%mfalu$&ntf#@ue3ew7lab+^hpggl+9p318h&&^'
...
CSRF_TRUSTED_ORIGINS = ['https://princecons.azurewebsites.net', '127.0.0.1']
